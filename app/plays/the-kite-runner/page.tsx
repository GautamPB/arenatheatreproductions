import TKRPoster from '@/assets/images/posters/tkr.png'
            ...
            <div className="mt-10">
                ...
                <div className="flex items-center flex-col md:flex-row">
                    ...
                    <div className="w-full text-center md:space-y-12 mt-12 md:mt-0 flex items-center justify-around md:flex-col space-y-0">
                        <h1 className="font-bold text-xl text-[#322C55] italic">
                            <span className="text-[5rem] text-[#4258A9]">
                                3{' '}
                            </span>{' '}
                            Venues
                        </h1>
                        <h1 className="font-bold text-xl text-[#322C55] italic">
                            <span className="text-[5rem] text-[#18153F]">
                                6{' '}
                            </span>{' '}
                            Shows
                        </h1>
